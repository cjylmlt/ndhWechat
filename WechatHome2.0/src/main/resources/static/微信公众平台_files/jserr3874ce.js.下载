...
n&&n[1]&&(e.action=n[1]);
var i=v.IDS.DEFAULT,r=v.KEY;
return"cgi-bin/masssendpage"==e.cgi?(i=v.IDS.MASS,r=66):"advanced/autoreply"==e.cgi?(i=v.IDS.AUTO_REPLY,
r=70):"advanced/selfmenu"==e.cgi?(i=v.IDS.SELF_MENU,r=68):"misc/appmsgcomment"==e.cgi?(i=v.IDS.COMMENT,
r=71):"cgi-bin/newoperatevote"==e.cgi?(i=v.IDS.VOTE,r=72):"misc/kf"==e.cgi?(i=v.IDS.KF,
r=73):"merchant/rewardstat"==e.cgi||"merchant/reward"==e.cgi?(i=v.IDS.REWARD,r=74):"cgi-bin/appmsgcopyright"==e.cgi||"cgi-bin/imgcopyright"==e.cgi||"cgi-bin/ori_video"==e.cgi?(i=v.IDS.COPYRIGHT,
r=75):"cgi-bin/message"==e.cgi?(i=v.IDS.MSG,r=76):"cgi-bin/user_tag"==e.cgi?(i=v.IDS.USER,
r=77):"cgi-bin/appmsg"==e.cgi&&("list_card"==e.action||"list"==e.action)||"cgi-bin/filepage"==e.cgi?(i=v.IDS.LIST,
r=78):"cgi-bin/operate_voice"==e.cgi?(i=v.IDS.AUDIO,r=79):"cgi-bin/appmsg"==e.cgi&&"video_edit"==e.action?(i=v.IDS.VEDIO,
r=80):""==e.cgi?(i=v.IDS.APPMSG,r=62):"cgi-bin/frame"==e.cgi&&/t=ad_system/.test(e.href)||/merchant\/ad_/.test(e.cgi)?(i=v.IDS.AD,
r=81):"misc/useranalysis"==e.cgi||"misc/appmsganalysis"==e.cgi||"misc/menuanalysis"==e.cgi||"misc/messageanalysis"==e.cgi||"misc/interfaceanalysis"==e.cgi?(i=v.IDS.ANALYSIS,
r=82):"cgi-bin/settingpage"==e.cgi||"acct/contractorinfo"==e.cgi?(i=v.IDS.SETTING,
r=83):"merchant/store"==e.cgi||"merchant/order"==e.cgi||"acct/wxverify"==e.cgi?(i=v.IDS.VERIFY,
r=84):"cgi-bin/safecenterstatus"==e.cgi||""==e.cgi||""==e.cgi?(i=v.IDS.SAFE,r=85):"cgi-bin/illegalrecord"==e.cgi?(i=v.IDS.ILLEGAL,
r=86):"advanced/advanced"==e.cgi||"advanced/diagram"==e.cgi||"cgi-bin/frame"==e.cgi&&/t=advanced\/dev_tools_frame/.test(e.href)?(i=v.IDS.ADVANCED,
r=87):"acct/contractorpage"==e.cgi?(i=v.IDS.REGISTER,r=88):"cgi-bin/readtemplate"==e.cgi?(i=v.IDS.TMPL,
r=89):"advanced/tmplmsg"==e.cgi?(i=v.IDS.TMPLMSG,r=90):"merchant/entityshop"==e.cgi||"merchant/newentityshop"==e.cgi?(i=v.IDS.SHOP,
r=92):"merchant/goods"==e.cgi||"merchant/goodsgroup"==e.cgi||"merchant/shelf"==e.cgi||"merchant/goodsimage"==e.cgi||"merchant/delivery"==e.cgi||"merchant/productorder"==e.cgi||"merchant/merchantstat"==e.cgi||"merchant/introduction"==e.cgi||"merchant/merchantpush"==e.cgi||"merchant/merchantentrance"==e.cgi?(i=v.IDS.MERCHANT,
r=104):"cgi-bin/home"==e.cgi?(i=v.IDS.HOME,r=93):"merchant/cardapply"==e.cgi&&"listapply"==e.action?r=95:e.cgi.indexOf("beacon")>-1&&(i=v.IDS.IBEACON,
r=96),t.id=i,t.key=r,{
id:i,
key:r
};
...
r&&r.length>0&&0==/^https\:\/\/(mp\.weixin\.qq\.com|res\.wx\.qq\.com)/.test(r),(1!=t||1!=o&&86!=o||-1!=n.indexOf("eval"))&&0!=i(s,window.navigator.userAgent)&&(v.push({
msg:s+"|onerror",
target:r,
rowNum:t,
colNum:o
...
if(i.target&&0==/^https?\:\/\/(mp\.weixin\.qq\.com|res\.wx\.qq\.com)/.test(i.target))return v;
r.push(i);
}
}else n&&(e+="["+n+"]"),r.push({
msg:e
...
return window.navigator.userAgent&&/;\s*MSIE\s*[8|7]\.0b?;/i.test(window.navigator.userAgent)?(i=v.IDS.IE,
n=0):window.navigator.userAgent.indexOf("Android")>-1||window.navigator.userAgent.indexOf("Adr")>-1?(i=v.IDS.Android,
n=0):window.navigator.userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/)&&(i=v.IDS.IOS,
...
},0,!0),t.id=v.IDS.DEFAULT,t.key=v.KEY,n(),v.init(),v;
}(window);