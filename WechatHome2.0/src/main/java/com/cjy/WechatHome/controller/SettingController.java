...
public class SettingController {
	...
	public String setUserSetting(@RequestParam("id") int id,@RequestParam("username") String username,@RequestParam("wechatId") String userId,@RequestParam("status") int status,@RequestParam("chineseName") String chineseName,@RequestParam("noteOne") String noteOne,@RequestParam("headUrl") String headUrl,Model model){		
		User visitUser = hostHolder.getUser();
	    User user;
	    DefinedReply ad = null;
