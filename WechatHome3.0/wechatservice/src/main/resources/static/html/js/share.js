function crossdomainCheck() {
	var hosts = "http://www.byjsj.cn";
	var redirecturl = "http://www.byjsj.cn";
	return true;
    if (hosts) {
...
function play(main, xml) {
    var hostname = "bf.k3k.org.cn"
    var port = "80";
    var picurl = "http://bf.k3k.org.cn" + pic;
    var url =  main;
    xml =  xml;
    var flashvars = {
        f: 'http://bf.k3k.org.cn/html/m3u8.swf',
        a: url,
        xml: xml,
        s: 4,
        i: picurl,
        ...
        u: u,
        c: 0,
        my_url: encodeURIComponent(main),
    ...
    CKobject.embed('http://bf.k3k.org.cn/html/ckplayer/ckplayer.swf', 'a1', 'ckplayer_a1', '100%', '100%', false, flashvars, video, params);
