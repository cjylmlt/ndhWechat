...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
		bufferprompt:'{a target="_blank" href="http://www.yibuyy.com"}{font color="#ffffff" size="12" face="Microsoft YaHei,YaHei,微软雅黑,SimHei,黑体"}一部影院，最好用的手机影院！{/font}{/a}',
		mainfuntion:'',
		/*
		...
		*/
		...
		/*
			跳过广告和播放结束时调用的js函数
		*/
        myweb: escape('739e225fd127c549a48d9e6e5f7403b1,一部影院,http://www.yibuyy.com,好好看呀'),
        /*
		------------------------------------------------------------------------------------------------------------------
...
(function() {
    var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
			...
			g = false,
            j = document,
            r = 'http://www.zzb.zjsjq.nj/xxcc/soft/network/23739.html',
            ...
            s += '<object pluginspage="http://www.zzb.zjsjq.nj/xxcc/soft/network/23739.html" ';
