...
import com.cjy.WechatHome.util.MovieUtil;
...
public class PermissionRequiredInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		// TODO Auto-generated method stub
//		String movieParam = MovieUtil.getMovieParam(request);
//		System.out.println(realUrl+movieParam);
//		if(request.getRequestURL().toString().contains(fakeUrl))
//        	response.sendRedirect("/tempredirect?realurl="+realUrl+movieParam);
		String ticket = null;
