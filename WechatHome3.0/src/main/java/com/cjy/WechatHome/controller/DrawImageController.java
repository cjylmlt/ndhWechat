...
@Controller
public class DrawImageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static int WIDTH = 120;//验证码尺寸
	public static int HEIGHT = 30;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DrawImageController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		setBorder(g);
		drawRandomLine(g);
		String random = drawRandomString((Graphics2D)g,createTypeFlag);
	...
	private String drawRandomString(Graphics2D g, String...createTypeFlag) {
		...
		if(createTypeFlag.length>0&&createTypeFlag[0]!=null){
			if(createTypeFlag[0].equals("ch")){
				return drawRandomChar(g,baseChineseChar);
			}
			else if(createTypeFlag[0].equals("nl")){
				return drawRandomChar(g, baseNumLetter);
			}
			else if(createTypeFlag[0].equals("l")){
				return drawRandomChar(g, baseLetter);
			}
			else if (createTypeFlag[0].equals("n")) {
				return drawRandomChar(g, baseNum);
			}
		}
		else {
			return drawRandomChar(g, baseNum);
	...
	private String drawRandomChar(Graphics2D g, String baseChar) {
